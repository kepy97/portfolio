...
function globalFunction() {
    ...
    (function($) {
        ...
        var onePageClick = function() {
            ...
            //Kepy changes: commented prevent default line
            //Kepy changes: updated href for scrollTop animate
            $(document).on('click', '#ftco-nav a[href^="#"]', function(event) {
                ...
                $('html, body').animate({
                    scrollTop: $('#'+href.split("#").pop()).offset().top - 70
                }, 500, function() {
    ...
    var shivam_gupta = "+917021577684"
    var narendra_dagar = "+919990562844"
    var sanjay_bhagat = "+919858110022"
